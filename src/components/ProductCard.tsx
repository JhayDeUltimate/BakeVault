    ...
    <div className="bg-white rounded-[20px] sm:rounded-[24px] shadow-sm border border-orange-100 overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group flex flex-col h-full">
      ...
      >
        <img src={product.image} alt={product.name}
          ...
          loading="lazy"
          onError={e => { (e.target as HTMLImageElement).src = 'https://images.unsplash.com/photo-1555507036-ab1f4038808a?auto=format&fit=crop&q=80&w=400' }}
        />
      ...
      <div className="p-3 sm:p-5 flex flex-col flex-grow text-center">
        ...
        <div className="mt-auto pt-2 sm:pt-4 border-t border-orange-50 space-y-2 sm:space-y-3">
          <div className="hidden sm:flex justify-center gap-2">
            <span className="text-brand-brown font-extrabold text-[9px] font-display tracking-tight uppercase bg-brand-brown/5 px-1.5 py-0.5 rounded-md border border-brand-brown/10">Retail</span>
            <span className="text-brand-darkGray/20 text-[9px]">|</span>
            <span className="text-brand-brown font-extrabold text-[9px] font-display tracking-tight uppercase bg-brand-brown/5 px-1.5 py-0.5 rounded-md border border-brand-brown/10">Wholesale</span>
          </div>
