              ...
              <div className="bg-white p-5 sm:p-8 rounded-[24px] sm:rounded-[32px] border border-orange-100 shadow-sm h-full flex flex-col justify-center text-center">
                <div className="flex justify-center gap-0.5 text-brand-orange mb-3">
                  {[...Array(5)].map((_, starIndex) => (
                    <svg key={starIndex} className="w-2.5 h-2.5 sm:w-3.5 h-3.5 fill-current" viewBox="0 0 20 20">
                ...
                <div className="flex items-center justify-center gap-3">
                  ...
                  <div className="text-left">
                    <p className="text-[10px] sm:text-xs font-bold text-brand-darkGray uppercase tracking-widest leading-none mb-1">{testimonial.name}</p>
                    <p className="text-[8px] sm:text-[10px] text-brand-brown font-bold uppercase">{testimonial.role}</p>
                  </div>
                </div>
              </div>
            </div>
