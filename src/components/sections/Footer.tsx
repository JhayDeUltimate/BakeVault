// src/components/sections/Footer.tsx — COMPLETE FIX
...
const Footer: React.FC = () => {
  ...
  const contactEmail = settings.contact_email || 'sales@bakevault.com'
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-10 sm:gap-16">
          ...
          <div className="flex flex-col gap-3">
            ...
            <a
              ...
              className="text-white/60 hover:text-white transition-colors font-medium text-xs flex items-center gap-2.5"
            >
