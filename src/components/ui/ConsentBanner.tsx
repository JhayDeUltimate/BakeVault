...
export default function ConsentBanner() {
  ...
  return (
    // Pinned to TOP on mobile so it doesn't overlap the bottom WhatsApp CTA button.
    // On sm+ screens it centres at the bottom as before.
    <div className="fixed top-0 left-0 right-0 z-50 sm:top-auto sm:bottom-6 sm:left-1/2 sm:right-auto sm:-translate-x-1/2 bg-white border-b sm:border border-orange-100 px-5 py-4 shadow-2xl flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:w-auto sm:max-w-3xl sm:rounded-2xl">
