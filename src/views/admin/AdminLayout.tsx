...
const NAV = [
  ...
  { to: 'faq', label: 'FAQ', d: 'M8 10h.01M12 10h.01M16 10h.01M9 16h6M21 12c0 4.418-4.03 8-9 8a9.77 9.77 0 01-4-.8L3 20l.8-3.2A7.45 7.45 0 013 12c0-4.418 4.03-8 9-8s9 3.582 9 8z' },
