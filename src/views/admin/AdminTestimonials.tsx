          ...
          <div key={t.id} className={`w-full min-w-0 overflow-hidden bg-white rounded-xl border shadow-sm p-5 ${t.is_visible ? 'border-gray-100' : 'border-gray-100 opacity-60'}`}>
            <div className="flex items-start justify-between gap-4">
              ...
              <div className="flex gap-2 shrink-0">
                <button onClick={() => toggleVisible(t)} title={t.is_visible ? 'Hide' : 'Show'} className="p-1.5 rounded-lg bg-gray-50 text-gray-400 hover:text-orange-500 hover:bg-orange-50 transition-colors">
