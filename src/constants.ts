...
export const PRODUCTS: Product[] = [
  { id: '1',  name: 'Yogourmet Yogurt Starter',               category: 'Yogurt & Dairy Starters',        price: 'Wholesale', image: 'https://images.unsplash.com/photo-1488477181946-6428a0291777?auto=format&fit=crop&q=80&w=1200', description: 'The gold standard for home and commercial yogurt production. Achieve a smooth, creamy texture and perfect tang every single time.' },
  { id: '4',  name: 'Lux Essence Milk Flavour',               category: 'Milk Flavorings & Essences',     price: 'Wholesale', image: 'https://images.unsplash.com/photo-1550507992-eb63ffee0847?auto=format&fit=crop&q=80&w=1200', description: 'A highly concentrated premium essence that delivers a rich, creamy aroma to breads, cakes, and dairy products.' },
  { id: '17', name: "Hershey's Chocolate Syrup",              category: 'Syrups & Toppings',              price: 'Wholesale', image: 'https://images.unsplash.com/photo-1606312619070-d48b4c652a52?auto=format&fit=crop&q=80&w=1200', description: 'Genuine chocolate flavor that remains smooth and decadent. Perfect for drizzling or mixing into rich batters.' },
  { id: '23', name: 'Havana Active Baking Powder',            category: 'Baking Ingredients',             price: 'Wholesale', image: 'https://images.unsplash.com/photo-1509440159596-0249088772ff?auto=format&fit=crop&q=80&w=1200', description: 'Engineered for tropical climates. Ensures a consistent, reliable rise for all your breads and pastries.' },
